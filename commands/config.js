  ...
  async execute(interaction) {
    try {
        ...
        .addOptions([
          {
            ...
            description:
              "Configure Discord roles (Premium, Warranty, Admin, etc.)",
            value: "roles",
            emoji: "🎭",
          },
          {
            ...
            description:
              "Configure Discord channels (Warranty, Support, Logs, etc.)",
            value: "channels",
            emoji: "📢",
          },
          {
      ...
      const errorEmbed = new EmbedBuilder()
        ...
        .setTitle("❌ Error")
        .setDescription(
          "An error occurred while loading the configuration menu.",
        )
        .setTimestamp();
