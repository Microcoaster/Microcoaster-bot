  ...
  data: new SlashCommandBuilder()
    ...
    .addChannelOption((option) =>
      option
        .setName("channel")
        .setDescription(
          "Channel to send the ticket panel (current channel if not specified)",
        )
        .setRequired(false),
    )
  ...
  async execute(interaction) {
    try {
      ...
      const ticketEmbed = new EmbedBuilder()
        ...
        .setDescription(
          `Welcome to our support center! Select the category that best matches your inquiry below.
